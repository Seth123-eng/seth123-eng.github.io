...
let totalAdmins = document.getElementById('totalAdmins')
let activeAdmins = document.getElementById('activeAdmins')
let pendingApprovals = document.getElementById('pendingApprovals')
...
firebase.database().ref('userDetails').once("value", function(snapshot) {
    ...
    pendingApprovals.innerHTML = total
})