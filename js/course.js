...
let pastCourses = document.getElementById('pastCourses')
let inSessionCourses = document.getElementById('inSessionCourses')
...
firebase.database().ref('Courses').once("value", function(snapshot) {
    ...
    inSessionCourses.innerHTML = total
})